...
table{
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script> 
   ...
   <center>
      <h1 style="font-family:Monotype corsiva;color:white"><u><b>POST COMPLAINT</b></u></h1>
...
echo '<script type="text/javascript">alert("Complaint Submitted Succesfully");window.location=\'profile.php\';</script>';
}
?>
</table>
</body>
