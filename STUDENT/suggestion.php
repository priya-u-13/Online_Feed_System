...
<body style="font-style:strong">
	 ...
	 <input type="hidden" name="suser" id="suser" value="<?php echo $suser;?>" class="form-control">
	 <input type="hidden" name="sname" id="sname" value="<?php echo $sname;?>" class="form-control">
...
$query =mysql_query("insert into s_suggestion (tid,suser,sname,sugg_id,stitle,sdate,sfile,sugg,apply,status,type) values ('$tid','$suser','$sname','$sugg_id','$stitle','$sdate','$sugg','$suggestion','$apply','$status','$type')");
