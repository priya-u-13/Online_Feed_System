		...
		<div class="col-sm-8">
			...
			<div class="panel panel-default">
				...
				<div class="list-group">
					...
					<?php
						$id=$_SESSION['Id'];
						$query=mysql_query("select * from teacher where id='$id'");
						...
						<form class="form-light mt-20" name="form" id="form" action="pro_update_in.php" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Aadhar</label>
								<input type="text" name="user" id="user" class="form-control" value="<?php echo $row['aadhar_no'];?>" readonly>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Name</label>
								<input type="text" name="user" id="user" class="form-control" value="<?php echo $row['name'];?>" readonly>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
                                        <label>Category</label>
								<input type="text" name="user" id="user" class="form-control" value="<?php echo $row['category'];?>" readonly>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="father" id="father" class="form-control" value="<?php echo $row['dpt'];?>" readonly>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
                                        <label>Joining Date</label>
								<input type="text" name="mother" id="mother" class="form-control" value="<?php echo $row['jdate'];?>" readonly>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="father" id="father" class="form-control" value="<?php echo $row['quali'];?>" readonly>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
                                        <label>Experience</label>
								<input type="text" name="mother" id="mother" class="form-control" value="<?php echo $row['exp'];?>" readonly>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="father" id="father" class="form-control" value="<?php echo $row['dasignation'];?>" readonly>
									</div>
								</div> 
								<div class="col-md-6">
									<div class="form-group">
                                        <label>Specilization</label>
								<input type="text" name="mother" id="mother" class="form-control" value="<?php echo $row['specialization'];?>" readonly>
									</div>
								</div>
							</div>
							<div class="row">
...
<div class="holder">
  <ul id="ticker01">
							...
							<?php
     $query =mysql_query("select * from notice where type='teacher' order by apply");
